...
class FBAuthPlugin(object):
    ''' This plugin determines if a Facebook user is logged in with the 
    Facebook Javascript SDK and returns the user context if they are.
    ...
    facebook.py in your sys.path for this plugin to work. For more information,
